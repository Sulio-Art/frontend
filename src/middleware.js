...
//       console.error(
//         "[Middleware] JWT_SECRET is not defined in environment variables"
//       );
//       return null;
//     }
...
//     request.cookies.get("isJustLoggedIn")?.value === "true";

//   if (pathname.startsWith("/dashboard") && isJustLoggedIn) {
//     console.log(
//       '[Middleware] Detected "isJustLoggedIn" flag, allowing access and clearing flag.'
//     );
...
//     console.log(
//       "[Middleware] Unauthorized dashboard access, redirecting to login"
//     );
...
//     console.log(
//       "[Middleware] Authenticated user accessing public path, redirecting to dashboard"
//     );
...
// We are protecting the entire /dashboard route and all its sub-paths.
