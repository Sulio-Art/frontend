      ...
      <Card className="w-full max-w-md p-8">
        ...
        {!showOtpForm ? (
          <form onSubmit={handleRegisterSubmit(onRegisterSubmit)} className="space-y-4">
            ...
            <Input {...registerForm('phoneNumber')} />
            {registerErrors.phoneNumber && <p className="text-red-500 text-sm">{registerErrors.phoneNumber.message}</p>}
            ...
            <Input type="password" {...registerForm('confirmPassword')} />
          ...
          <form onSubmit={handleOtpSubmit(onOtpSubmit)} className="space-y-4">
            <Label>OTP</Label>
            <Input {...registerOtp('otp')} placeholder="6-digit code" />
