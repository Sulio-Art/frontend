...
const invoices = [
  { id: "INV-001", date: "June 15, 2023", amount: "$19.99", status: "Paid" },
  { id: "INV-002", date: "May 15, 2023", amount: "$19.99", status: "Paid" },
  { id: "INV-003", date: "April 15, 2023", amount: "$19.99", status: "Paid" },
  { id: "INV-004", date: "March 15, 2023", amount: "$19.99", status: "Paid" },
  {
    id: "INV-005",
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {plans.map((plan) => (
              <Card
                key={plan.name}
                className={`border overflow-hidden ${plan.current ? "border-purple-500 shadow-md" : "border-gray-200"}`}
              >
                {plan.current && (
                  ...
                  <div className="mt-4 space-y-2">
                    {plan.features.map((feature, idx) => (
                      <div key={idx} className="flex items-start">
                        ...
                        <span
                          className={`text-sm ${feature.included ? "text-gray-700" : "text-gray-500"}`}
                        >
                          {feature.name}
                        </span>
                      </div>
